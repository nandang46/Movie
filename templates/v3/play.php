...
<head>
	...
	<title>Watch <?php echo $row['name'];?><?php echo $movie_title;?> <?php echo $config->meta_title;?> Full Movie</title>
	<meta name="description" content="<?php echo $_ocim->short($row['overview']);?>">
	<meta name="keywords" content="<?php echo $row['name'];?><?php echo $movie_title;?> <?php echo $config->meta_title;?>,<?php echo $keywords;?>">
...
<center><div class="available-formats-wrapper">
			...
			<h1 class="text-center media-heading" style="margin-top: 10px;">Watch <?php echo $row['name'];?><?php echo $movie_title;?> Full Series Streaming</h1>
			...
			<div class="row" style="margin-top:25px;">
						<div class="col-sm-3 col-xs-12">
							<img src="<?php echo $images_small;?>" alt="<?php echo $row['name'];?><?php echo $movie_title;?> <?php echo $config->meta_title;?>" class="img-responsive thumbnail" style="margin:0 auto;">
		...
		<div class="col-md-12 col-xs-12">
			<div class="text-center h3" style="margin-top: 0;font-size: 18px;">Similar TV Series</div>
			<?php
                        ...
                        $i = 0;
                      		foreach($SimilarMovie['results'] as $sim) {
                                        ...
                                        if ($sim['poster_path']!=null) {
                                           	$image = 'http://image.tmdb.org/t/p/w1280'.$sim['poster_path'];
                                        }else{
                                           	$image = '/include/images/no-poster-w185.jpg';
                                        }	
                                ?>
			        <div class="col-md-2 col-sm-4 col-xs-4">
				        <a href="<?php echo seo_tv($sim[id],$sim[name]);?>" title="<?php echo $sim['name'];?>" class="text-center">
					        <img src="<?php echo $image;?>" alt="<?php echo $sim['name'];?>" class="gird-pic img-responsive" style="height:190px;width: 100%;">
					        <span style="font-size: 12px;background-color: rgba(0, 0, 0, 0.77);text-shadow: 1px 1px 1px #000;color: #FFF;padding: 5px;" class="nowrap"><?php echo $sim['name'];?></span>
				        </a>
			        </div>
			        <?php 
                                if ($i++ == 5) break;
